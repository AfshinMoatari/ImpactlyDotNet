...
{
    public class IncidentReportModuleConfigViewValidator : AbstractValidator<IncidentReportModuleConfigViewModel>
    {
        public IncidentReportModuleConfigViewValidator()
        {
